...
from src.infrastructure.persistence.db import schema  # noqa: F401
...
config.set_section_option(
    section, "DB_PASS", os.environ.get("DB_PASS", "postgress")
)
...
config.set_section_option(section, "DB_NAME", os.environ.get("DB_NAME", "tasks_db"))
